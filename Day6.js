const inpArr = [
  ...
  const countriesInAsia = inpArr
    .filter((data) => data.region === "Asia")
    .map((data) => data.name.common);
  
  const populationLessThan2L = inpArr
    .filter((data) => data.population < Number(200000))
    .map((data) => data.name.common);
  
  const printDetails = inpArr.map(
    (data) =>
      `Name: ${data.name.common}, Capital: ${data.capital}, Flag: ${data.flag}`
  );
  
  const totalPopulation = inpArr.reduce(
    (sum, data) => (sum += Number(data.population)),
    0
  );
  
  console.log(
    `=========================================================================
      a_Get all the countries from Asia continent /region using Filter function: 
      -----------------------------------------------------------------------------------\n`,
    countriesInAsia
  );
  ...
  console.log(
    `===================================================================================
      b_Get all the countries with a population of less than 2 lakhs using Filter function: 
      ------------------------------------------------------------------------------------\n`,
    populationLessThan2L
  );
  
  console.log(
    `===================================================================================
      c_Print the following details name, capital, flag, using forEach function: 
      ------------------------------------------------------------------------------------\n`,
    printDetails
  );
  ...
  console.log(
    `===================================================================================
      d_Print the total population of countries using reduce function: 
      `,
    totalPopulation
  );
  ...
  console.log("e_Print the country that uses US dollars as currency.");
  console.log(
    "-------------------------------------------------------------------------"
  );
  
  const countriesUsingUSD = inpArr.forEach((data) => {
